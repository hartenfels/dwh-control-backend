...
use App\EtlMonitor\Api\Exceptions\MissingRequestFieldException;
use App\EtlMonitor\Api\Exceptions\UnhandleableRelationshipException;
use App\EtlMonitor\Api\Http\Controllers\Actions\DestroyAction;
use App\EtlMonitor\Api\Http\Controllers\Actions\StoreAction;
use App\EtlMonitor\Api\Http\Controllers\Actions\UpdateAction;
...
class Controller extends \App\Http\Controllers\Controller
{
     ...
     * @return JsonResponse
     */
    protected function respondFiltered(EloquentBuilder|QueryBuilder $query): JsonResponse
    {
     ...
     * @return JsonResponse
     */
    protected function respondFilteredAndPaginated(EloquentBuilder|QueryBuilder $query, callable $model_retrieval_service = null): JsonResponse
    {
    ...
    protected function getModelName(): string
    {
        ...
        return '\\App\\EtlMonitor\\' . $this->package . '\\Models\\' . $class_name;
    }
    ...
    {
        preg_match(
            "/EtlMonitor\\\([A-Za-z]+)\\\Http\\\Controllers\\\([A-Za-z]+)Controller@([A-Za-z_\-]+)/",
