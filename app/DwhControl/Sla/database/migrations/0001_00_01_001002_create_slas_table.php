...
class CreateSlasTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('dwh_control_sla__slas', function (Blueprint $table) {
        ...
        Schema::table('dwh_control_sla__slas', function (Blueprint $table) {
            $table->foreign('sla_definition_id', 'sla__definition_foreign')->references('id')->on('dwh_control_sla__sla_definitions');
            $table->foreign('timerange_id', 'sla__timerange_foreign')->references('id')->on('dwh_control_sla__timeranges');
    ...
    {
        Schema::dropIfExists('dwh_control_sla__slas');
    }
}
